...
-- Number_of_films, average_replacement_cost, total_replacement_cost, GROUP BY STORE and film category
...
-- Lista de advisor and investor names in 1 Table, marcar si son investor o advisor, y para los investor marcar con que compañia ellos trabajan
